...
def get_user_recommendations(user_id, top_k=100, **kwargs):
    try:
        ...
        candidates = set()
        N_RECENT = 30  # последние N_RECENT товаров пользователя, чем больше значение тем больше персонализация (купленные не учитываеются)
        ...
        N_POPULAR = 5  # просто топ популярынх товаров,
